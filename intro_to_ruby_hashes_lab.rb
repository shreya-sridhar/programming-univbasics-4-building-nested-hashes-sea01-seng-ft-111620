...
def monopoly_with_third_tier
  ...
  hash3[:railroads][:names]={:reading_railroad => {:mortgage_value => 100},:pennsylvania_railroad => {:mortgage_value => 200},:b_and_o_railroad => {:mortgage_value => 400},:shortline_railroad => {:mortgage_value => 800}}
  return hash3
end
